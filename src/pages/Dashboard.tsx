  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <KPICard icon={<MessageSquare className="h-4 w-4 text-primary" />} label="Média Comentários" value={avgComments} tooltip="Média de comentários por cliente, indica engajamento da equipe" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="border rounded-lg bg-card p-5 lg:col-span-2 cursor-default">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="border rounded-lg bg-card p-5 cursor-default">
...
function KPICard({ icon, label, value, tooltip }: { icon: React.ReactNode; label: string; value: number | string; tooltip: string }) {
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <div className="border rounded-lg bg-card p-4 cursor-default">
